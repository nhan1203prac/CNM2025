...
const Profile = () => {
  ...
  const handleFileChange = async (e) => {
    ...
    const toastId = toast.loading("Đang tải ảnh lên..."); // Hiện thông báo chờ
    setIsUploading(true);
        ...
        <div className="p-6 md:p-8 space-y-8">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex flex-col gap-3 justify-center">
              ...
              <p className="text-xs text-gray-500 italic">Hệ thống sử dụng Cloudinary để tối ưu tốc độ tải ảnh.</p>
              <button 
                type="button" 
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-bold text-gray-400">Email (Không thể thay đổi)</label>
              <input className="w-full h-12 px-4 rounded-lg border border-[#e6e0db] bg-gray-50 text-gray-400" disabled value={formData.email} />
            </div>
            ...
            <div className="md:col-span-2 pt-4 flex justify-end">
              <button 
                className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-lg shadow-md transition-all disabled:bg-gray-400" 
                type="submit"
                disabled={isUploading}
              >
                Lưu thay đổi
