    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-8">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-40">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2 text-[#181411]">
              ...
              <h2 className="text-lg font-bold">ShopMới</h2>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed">Nền tảng mua sắm trực tuyến hàng đầu với đa dạng sản phẩm và dịch vụ chất lượng cao.</p>
          </div>
          <div>
            <h3 className="font-bold text-[#181411] mb-4">Về chúng tôi</h3>
          ...
          <div>
            <h3 className="font-bold text-[#181411] mb-4">Hỗ trợ khách hàng</h3>
            <ul className="flex flex-col gap-2 text-sm text-gray-500">
          ...
          <div>
            <h3 className="font-bold text-[#181411] mb-4">Đăng ký nhận tin</h3>
            <div className="flex gap-2">
              <input className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 text-sm w-full focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary" placeholder="Email của bạn" type="email"/>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
          <p>© 2024 ShopMới. All rights reserved.</p>
